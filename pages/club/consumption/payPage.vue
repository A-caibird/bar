	...
	export default{
		...
		computed:{
			buyMustKnowList(){
				...
				// 	return ['感谢您的光临，请在规定时间内到达场所否则将取消您的本次预约，过时将不予退还','待有空余台位或改日进行消费','未成年禁止娱乐后果自负']
				// }
				return ['感谢您的光临，请在预订时间内到达场所否则将自动取消，您的本次预约，过时将不予退还', '若超过预约时间，您有一次改期机会，可在酒吧重新选位下单，第二次将不予改期，只能存酒', '改期所选台位的最低消费不得高于逾期订单的支付金额', '请在有效期内按规定重新下单或取酒，如有疑问，请及时联系客服', '未成年人禁止娱乐后果自负']
			},
		},
		onLoad(opt) {
